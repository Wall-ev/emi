...
public class EmiScreenManager {
    ...
    private static void updateTypeRecipes(Screen screen) {
        ...
        if (updateTypeRecipesCon != null) {
            ...
            String name = "";
            if (screen instanceof HandledScreen hs && hs.getScreenHandler() instanceof AbstractRecipeScreenHandler) {
                name = hs.getScreenHandler().getClass().getName();
    ...
    public static void setGetContainerClassName(Function<Screen, String> func) {
        getContainerClassNameFunc = func;
    }

    public static void setUpdateTypeRecipesCon(Consumer<Screen> updateTypeRecipesCon1) {
        updateTypeRecipesCon = updateTypeRecipesCon1;
    }

    public static void setUpdateCraftablesCon(Consumer<Void> con) {
        updateCraftablesCon = con;
    }
            ...
            if (!inv.isEqual(lastPlayerInventory)) {
                ...
                if (updateCraftablesCon != null) {
                    updateCraftablesCon.accept(null);
                        ...
                        !EmiSidebars.typeRecipes.isEmpty() &&
                        EmiRecipeFiller.getAllHandlers(EmiApi.getHandledScreen()).isEmpty()) {

                    EmiSidebars.craftables = EmiSidebars.typeRecipes.stream().filter(emiIngredient -> {
